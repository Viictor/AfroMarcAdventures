 ...
 * Date: 17/09/13
 */
public class MovingBoundingRect extends BoundingShape {
    ...
    public MovingBoundingRect(float x, float y, float width, float height) {
        this.x = x + width/2;
        this.y = y + height/2;
        this.width = width;
        this.height = height;
    ...
    @Override
    protected boolean checkCollision(AABoundingRect box) {
